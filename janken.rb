...
class Player #クラス名を定義
  ...
  class Enemy #クラス名を定義
    def hand #defの後にはメソッド名をつける
      ...
      enemy_hand = rand(0..2) #配列の要素からランダムで値を取得し変数へ代入
    end
  end
  # プレイヤー(自分)が入力した「0~2」と、敵がランダムで生成した「0~2」をじゃんけんをさせて、その結果をコンソール上に出力するロジックを書きます。
  class Janken #クラス名を定義
    def pon(player_hand, enemy_hand) #defの後にはメソッド名(引数名)をつける
